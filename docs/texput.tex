...
\begin{figure}
  \lstinputlisting[firstline=20, lastline=82, language=python, caption=Forward 1-iteration DWT
    (\href{https://github.com/vicente-gonzalez-ruiz/MCDWT/blob/master/src/DWT.py}{DWT.py})]{../src/DWT.py}
  \lstinputlisting[firstline=84, lastline=105, language=python,
    caption=Backward 1-level DWT
    (\href{https://github.com/vicente-gonzalez-ruiz/MCDWT/blob/master/src/DWT.py}{DWT.py})]{../src/DWT.py}
  \caption{Implementation of the color DWT step (forward and
    backward). $L$ and $H$ stands for \emph{low-pass filtered} and
    \emph{high-pass filtered}, respectively.  More information about the
...
\begin{figure}
  ...
  \lstinputlisting[firstline=21, lastline=42, language=python, caption=Forward MDWT (\href{https://github.com/vicente-gonzalez-ruiz/MCDWT/blob/master/src/MDWT.py}{MDWT.py})]{../src/MDWT.py}
  \lstinputlisting[firstline=44, lastline=66, language=python, caption=Backward MDWT (\href{https://github.com/vicente-gonzalez-ruiz/MCDWT/blob/master/src/MDWT.py}{MDWT.py})]{../src/MDWT.py}
  \caption{MDWT.} %
  \label{fig:forward_MDWT}
\end{figure}

\lstinputlisting[firstline=16, lastline=66, language=python, caption=\href{https://github.com/vicente-gonzalez-ruiz/MCDWT/blob/master/src/MDWT.py}{MDWT.py}]{../src/MDWT.py}
...
\end{figure}
\lstinputlisting[firstline=17, lastline=71, language=python, caption={MCDWT.py (extract)}]{../src/MCDWT.py}
