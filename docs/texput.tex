% Emacs, this is -*-latex-*-
\title{\href{https://github.com/Sistemas-Multimedia/MCOLP}{Motion Compensated Orthogonal Laplacian Pyramid (MCOLP)}}
...
\begin{figure}
  \lstinputlisting[firstline=20, lastline=85, language=python, caption=1-iteration DWT
    (\href{https://github.com/Sistemas-Multimedia/MCOLP/blob/master/src/DWT.py}{DWT.py}).]{../src/DWT.py}
...
\begin{figure}
  ...
  \lstinputlisting[firstline=21, lastline=42, language=python,
    caption=MDWT
    (\href{https://github.com/Sistemas-Multimedia/MCOLP/blob/master/src/MDWT.py}{MDWT.py}).]{../src/MDWT.py}.
...
\begin{figure}
  ...
  \lstinputlisting[firstline=23, lastline=49, language=python,
    caption={MCOLP butterfly
      (\href{https://github.com/Sistemas-Multimedia/MCOLP/blob/master/src/MCOLP.py}{MCOLP.py}).}]{../src/MCOLP.py}
  ...
  \lstinputlisting[firstline=4, lastline=9, language=python,
    caption={Computation of the prediction
      image (\href{https://github.com/Sistemas-Multimedia/MCOLP/blob/master/src/simple_average.py}{simple\_average.py}).}]{../src/simple_average.py}
...
\begin{figure}
  ...
  \lstinputlisting[firstline=79, lastline=131, language=python, caption={MCOLP (\href{https://github.com/Sistemas-Multimedia/MCOLP/blob/master/src/MCOLP.py}{MCOLP.py}).}]{../src/MCOLP.py}
  \lstinputlisting[firstline=133, lastline=174, language=python, caption={iMCOLP (\href{https://github.com/Sistemas-Multimedia/MCOLP/blob/master/src/MCOLP.py}{MCOLP.py}).}]{../src/MCOLP.py}
...
Fig~\ref{fig:MCOLP_decomposition}). Notice that, in a I-type image,
...
After using MCOLP, I-type images are decomposed into
