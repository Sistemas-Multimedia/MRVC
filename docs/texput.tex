...
\subsection{Simple 2D-DWT 1-levels example}
\begin{verbatim}
...
python3 -O DWT.py -p /tmp/ -i 000 -d 000
...
python3 -O DWT.py -b -p /tmp/ -d 000 -i reconstruction

# Visualize the reconstruction:
display -normalize /tmp/reconstruction.png 

# Show diferences:
../tools/show_differences.sh -1 /tmp/reconstruction.png -2 /tmp/000.png -o /tmp/diffs.png
display -normalize /tmp/diffs.png
\end{verbatim}

\subsection{Simple 2D-DWT 2-levels example}
\begin{verbatim}
# You must be in the 'src' directory.
...
# Second level:
python3 -O DWT.py -p /tmp/LL -i 000 -d 000

# Visualize the subbands:
ls -l /tmp/*.png

# Reverse second level:
python3 -O DWT.py -b -p /tmp/LL -i reconstruction -d 000
display -normalize /tmp/LLreconstruction.png

# Reverse first level:
cp /tmp/LLreconstruction.png /tmp/LL000.png
python3 -O DWT.py -b -p /tmp/ -i reconstruction -d 000
display -normalize /tmp/reconstruction.png
