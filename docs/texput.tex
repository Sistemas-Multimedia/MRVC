...
\lstinputlisting[firstline=20, lastline=82, language=python,
  caption=Forward 1-level DWT
...
\lstinputlisting[firstline=21, lastline=66, language=python,
  caption=\href{https://github.com/vicente-gonzalez-ruiz/MCDWT/blob/master/src/MDWT.py}{MDWT.py}]{../src/MDWT.py}
...
\begin{figure}
  ...
  \caption{MCDWT($S=1$, $T=3$) decomposition (notice that $\text{GOP\_size}=8=2^T$).} %
...
\section{Encoding of B-type images}
%{{{
