...
% CSLPT Critically Sampled LPT (critically-sampled octave-band decomposition (R=1 (basis expansion))
% CSSIDWT Critically-Sampled Shift-Invariant DWT (critically-sampled octave-band decomposition (R=1 (basis expansion))
