...
transformed using the DWT of 2 levels, we get:
\begin{itemize}
\item Subband $s_1.L^2$ with the scale 2.
\item Subband $s_1.L^1=s_1.L=\text{iDWT}(s_1.L^2, S_1.H^2)$ ($\text{iDWT}=\text{inverse DWT}=\text{backward DWT}$) with the scale $1$.
