...
1-iteration DWT applied to the $LL$ subband, $N$ times, producing a
...
generating 3 SRLs: (1) $LL_2$, (2) $LL_1=\mathtt{iDWT}(LL_2, LH_2,
HL_2, HH_2)$, and (3) $LL_0=\mathtt{iDWT}(LL_1, LH_1, HL_1, HH_1)$,
where $\mathtt{iDWT}$ stands for inverse DWT.
...
For the sake of simplicity, we will denote the spatial image $I$
subbands $\{I.LH_k, I.HL_k, I.HH_k\}$ as only $I.H_k$, and $I.LL_k$ as
only $I.L_k$. See
