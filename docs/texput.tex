...
\subsection*{2-iterations MCDWT example}
This example is similar to the previous, but now the number of
iterations of MCDWT is $I=2$. This second iteration compensates also
the $H$ subband of the image 2. This example matches exactly with the
described in the Fig~\ref{fig:MCDWT}.
