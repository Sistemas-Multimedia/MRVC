...
Now, we define the similarity maps as
\begin{equation}
  \begin{array}{l}
    {[s_a.L]} = \frac{\displaystyle 1}{\displaystyle 1+{[e_a.L]}}\\
    {[s_c.L]} = \frac{\displaystyle 1}{\displaystyle 1+{[e_c.L]}}.    
  \end{array}
\end{equation}
