...
\begin{enumerate}
\item $L^0_1=\{F_0.L^1, \cdots, F_4.L^1\}$ which when decoded, reconstruct the sequence of frames with a resolution $Y/2\times X/2$ at the original frame rate.
\item $H^$L^1_0=\{F_0.L^0, F_2.L^0, F_4.L^0\}$ which when decoded, reconstruct frames $F_0$, $F_2$, and $F_4$ with a resolution $Y\times X$.
\item $L^0_0=\{F_0.L^0, \cdots, F_4.L^0\}$ 
\end{enumerate}
