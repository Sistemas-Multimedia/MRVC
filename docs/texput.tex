...
\begin{figure}
  ...
  \lstinputlisting[firstline=21, lastline=42, language=python,
    ...
    (\href{https://github.com/vicente-gonzalez-ruiz/MCDWT/blob/master/src/MDWT.py}{MDWT.py}).]{../src/MDWT.py}.
...
\begin{figure}
  ...
  \lstinputlisting[firstline=17, lastline=43, language=python,
    caption={Forward MCDWT butterfly
      (\href{https://github.com/vicente-gonzalez-ruiz/MCDWT/blob/master/src/MCDWT.py}{MCDWT.py}).}]{../src/MCDWT.py}
  ...
  \lstinputlisting[firstline=4, lastline=9, language=python,
    caption={Computation of the prediction
      image (\href{https://github.com/vicente-gonzalez-ruiz/MCDWT/blob/master/src/simple_average.py}{simple\_average.py}).}]{../src/simple_average.py}
