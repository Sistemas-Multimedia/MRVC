...
GOP0          GOP 1
---- ------------------------
  s0                       s8  <- output of the 3-iterations MCDWT. Provides TRL #3.
               s4              <- first iteration of the inverse MCDWT. Provides TRL #2.
         s2          s6        <- second iteration. Provides TRL #1.
      s1    s3    s5    s7     <- third iteration. Provides TRL #0.
...
The GOP size is $4$, producint in this case $3$ TRLs. $4$ is the number of
SRLs.
...
%{{{
\subsection*{Example: Effects caused by the \mylink{quantization}{quantization} of MC $H$ subbands}
\begin{verbatim}
predictor=2
...
\subsection*{Example: Quantization of all $H$ subbands (MC and intra)}
\begin{verbatim}
predictor=2
