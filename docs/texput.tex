...
echo MDWT > /tmp/1
printf "%61s\n" MCDWT > /tmp/2
python3 ../tools/show_statistics.py -i /tmp/tmp/LH001.png >> /tmp/1
python3 ../tools/show_statistics.py -i /tmp/LH001.png >> /tmp/2
paste /tmp/1 /tmp/2 | less
...
echo MDWT > /tmp/1
printf "%61s\n" MCDWT > /tmp/2
python3 ../tools/show_statistics.py -i /tmp/tmp/HL001.png >> /tmp/1
python3 ../tools/show_statistics.py -i /tmp/HL001.png >> /tmp/2
paste /tmp/1 /tmp/2 | less
...
echo MDWT > /tmp/1
printf "%61s\n" MCDWT > /tmp/2
python3 ../tools/show_statistics.py -i /tmp/tmp/HH001.png >> /tmp/1
python3 ../tools/show_statistics.py -i /tmp/HH001.png >> /tmp/2
paste /tmp/1 /tmp/2 | less
