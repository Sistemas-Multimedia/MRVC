...
def main():
    ...
    subprocess.run("python3 -O ../src/MCDWT.py -d /tmp/{}/MDWT/ -m /tmp/{}/MDWT/MCDWT/1/ -N {}".format(videoName, videoName, nFrames), shell=True, check=True)
    ...
    if nLevel > 1:
        ...
        for i in range(nLevel-1):
            ...
            subprocess.run("python3 -O ../src/MCDWT.py -d {}{}/ -m {}{}/ -N {}".format(mlevelpath, i+1 , mlevelpath, i+2 , nFrames), shell=True, check=True)
    ...
    if nLevel > 1:
        ...
        for i in reversed(range(nLevel-1)):
            ...
            subprocess.run("python3 -O ../src/MCDWT.py -b -m {}{}/ -d {}{}/ -N {}".format(mlevelMCDWT, i+2 , mlevelrecons, i+1, nFrames-1), shell=True, check=True)
        ...
        # Reconstructs form the last MCDWT level
            ...
            subprocess.run("python3 -O ../src/MCDWT.py -b -m /tmp/{}/MDWT/MCDWT/1/ -d /tmp/{}/_reconMCDWT/1/ -N {}".format(videoName, videoName, nFrames-1), shell=True, check=True)
